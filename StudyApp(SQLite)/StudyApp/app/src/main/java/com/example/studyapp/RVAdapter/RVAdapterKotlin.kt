...
class RVAdapterKotlin (val activity: Kotlin, var KotlinList : ArrayList<Details> ): RecyclerView.Adapter<RVAdapterKotlin.ItemViewHolder>() {
    ...
    fun Update(KotlinList : ArrayList<Details>){
