...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Phrase = (PhraseList[Random.nextInt(0,PhraseList.size)]).toLowerCase()  // Select a phrase random from a list
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when(item.itemId){
            R.id.Add -> {
                startActivity(Intent(this,AddPhrase::class.java))
            }
        }
